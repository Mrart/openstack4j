...
public interface FirewallUpdateBuilder extends Builder<FirewallUpdateBuilder, FirewallUpdate> {
    ...
    /**
     * @param description
     *            : Human readable description for the firewall (1024 characters
     *            limit).
     * @return FirewallUpdateBuilder
     */
    ...
    /**
     * @param adminstateup
     *            : The administrative state of the firewall, which is up (true)
     *            or down (false).
     * @return FirewallUpdateBuilder
     */
    ...
    /**
     * shared : When set to True makes this firewall rule visible to tenants
     * other than its owner, and can be used in firewall policies not owned by
     * its tenant.
     * 
     * @return FirewallUpdateBuilder
     */
     ...
     *            with. This firewall will implement the rules contained in the
    ...
    /**
     * @param routerIds
     *            : A list of UUIDs for routers that are associated with the
     *            firewall.
